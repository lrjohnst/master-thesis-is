...
function snapToRoads($points) {
    ...
    $params = array(
        "path" => implode("|", $points),
        "interpolate" => "true",
        "key" => "AIzaSyDVri7EHu9TG1e8vOAkuNKZOvkDehZHqAo"  // Replace with your own Google API key
    );
...
//    die;
    ...
    $map_html = "<html>
        <head>
            <script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyDVri7EHu9TG1e8vOAkuNKZOvkDehZHqAo'></script>
            <style>
                #map {
                    height: 100%;
                }
